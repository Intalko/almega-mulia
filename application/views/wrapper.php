                    ...
                    <div class="container">
                        <div class="sec-title2 w-100">
                            <div class="sec-title-inner2 d-inline-block">
                                <h2 class="mb-0">Hot Deal Ship Buildup <i>15% <br> Off</i></h2>
                                <p class="mb-0">We Fight for justice, we are always ready to best solution for your problem.</p>
                            </div>
                        </div>
                ...
                <div class="w-100 pt-100 pb-50 position-relative">
                    <div class="container">
                        ...
                        <div class="view-all w-100 text-center">
                            <a class="thm-btn thm-bg" href="<?=base_url()?>/template/blog.html" title="">View All News<i class="flaticon-arrow-pointing-to-right"></i></a>
                        </div><!-- View All -->
                    </div>
                </div>
            </section>
